        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td><input type="text" name="cg_recaptcha_site_key" value="<?php echo esc_attr( get_option('cg_recaptcha_site_key') ); ?>" /></td>
                </tr>
                <tr>
                    <th>reCAPTCHA Secret Key:</th>
                    <td><input type="text" name="cg_recaptcha_secret_key" value="<?php echo esc_attr( get_option('cg_recaptcha_secret_key') ); ?>" /></td>
                </tr>
            </table>
            <?php submit_button(); ?>
        </form>
